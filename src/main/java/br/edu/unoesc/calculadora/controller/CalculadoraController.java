...
public class CalculadoraController {
	...
	public String subtraiQuery(@RequestParam(value = "n1", defaultValue = "0") String n1,
			@RequestParam(value = "n2", defaultValue = "0") String n2,
			RedirectAttributes atributos) {
		atributos.addAttribute("x1", "34");
		atributos.addFlashAttribute("x2", "50");
	...
	public String subtraiPath(@PathVariable String numero1,
			@PathVariable String numero2,
			@ModelAttribute("x1") String x1,
			@ModelAttribute("x2") String x2,
			ModelMap model) {
		System.out.println(x1 + " " + x2);
		System.out.println(model.getAttribute("x1") + " " + model.getAttribute("x2"));
	...
	public String multiplicaForwardQuery(@RequestParam(value = "n1", defaultValue = "0") String n1,
			...
			ModelMap model,
			HttpServletRequest requisicao) {
		model.addAttribute("x1", "67");
		requisicao.setAttribute("x2", "3456");
	...
	public String multiplicaForwardPath(@PathVariable String numero1,
			...
			Model model,
			HttpServletRequest requisicao) {
		System.out.println(requisicao.getAttribute("x1"));
		System.out.println(requisicao.getAttribute("x2"));
